...
class CloudFirestoreClass {
  ...
  Future<UserDetailsModel> getNameAndAddress() async {
    ...
    UserDetailsModel userModel =
        UserDetailsModel.fromJson(snapshot.data() as Map<String, dynamic>);
  ...
  Future<String> uploadImageToDatabase(
    ...
    Reference storageRef = _firebaseStorage.ref().child("products").child(uid);
  ...
  Future<List<Widget>> getProductsFromDiscount(int discount) async {
    ...
    for (var i = 0; i < snap.docs.length; i++) {
      ...
      ProductModel model = ProductModel.getModelFromJson(
          json: docSnap.data() as Map<String, dynamic>);
